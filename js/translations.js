...
const translations = {
    hr: {
        // Meta & SEO
        metaTitle: "Taxi Poreč | 24/7 Taxi Usluga & Transferi do Aerodroma | +385 98743679",
        metaDescription: "Profesionalna taxi usluga u Poreču, Hrvatska. Transferi do aerodroma, dostupnost 24/7, iskusni vozači. Rezervirajte sada putem WhatsApp ili nazovite +385 98743679.",
        ...
        // Hero Section
        heroTitle: "Taxi Poreč - Vaš Pouzdani Partner za Prijevoz u Istri",
        heroSubtitle: "Profesionalna taxi usluga dostupna 24/7. Transferi do aerodroma, obilasci grada i više. Rezervirajte sada za brzu, udobnu vožnju.",
        heroCallNow: "Pozovi Odmah",
        heroWhatsApp: "WhatsApp",
        
        // Why Choose Us
        whyChooseTitle: "Zašto Odabrati Taxi Poreč?",
        feature1Title: "Dostupnost 24/7",
        feature1Text: "Usluga non-stop, svaki dan u godini. Tu smo kada nam trebate.",
        feature2Title: "Profesionalni Vozači",
        feature2Text: "Licencirani, iskusni vozači s izvrsnim poznavanjem lokacije i engleskog jezika.",
        feature3Title: "Moderna Flota",
        feature3Text: "Čista, udobna, klimatizirana vozila održavana po najvišim standardima.",
        feature4Title: "Fiksne Cijene",
        feature4Text: "Transparentne cijene bez skrivenih troškova. Znate cijenu prije vožnje.",
        
        // Services
        servicesTitle: "Naše Usluge",
        service1Title: "Transferi do Aerodroma",
        service1Desc: "Pouzdani transferi između aerodroma Pula i Poreča. Praćenje leta, usluga dočeka i udobne vožnje.",
        service1Item1: "Aerodrom Pula → Poreč: ~60 min",
        service1Item2: "Aerodrom Trst → Poreč: ~90 min",
        service1Item3: "Aerodrom Zagreb → Poreč: ~3 sata",
        
        service2Title: "Gradski Transferi",
        service2Desc: "Lokalni prijevoz unutar Poreča i okolnih područja. Brza, učinkovita usluga za sve vaše dnevne potrebe.",
        service2Item1: "Poreč, Tar-Vabriga, Vrsar",
        service2Item2: "Funtana, Novigrad",
        service2Item3: "Brzi odaziv",
        
        service3Title: "Obilasci Istre",
        service3Desc: "Otkrijte ljepotu Istre s našim vođenim turama. Posjetite Rovinj, Motovun, Grožnjan i druge prekrasne destinacije.",
        service3Item1: "Rovinj, Motovun, Pula Arena",
        service3Item2: "Brijunski otoci",
        service3Item3: "Prilagođene ture",
        
        service4Title: "Transferi na Duge Relacije",
        service4Desc: "Udobne vožnje na duge relacije do Zagreba, Ljubljane, Trsta, Venecije i drugih većih gradova.",
        service4Item1: "Zagreb, Ljubljana, Trst",
        service4Item2: "Venecija, Split",
        service4Item3: "Komforna vožnja",
        
        // How to Book
        howToBookTitle: "Jednostavna Rezervacija u 3 Koraka",
        step1Title: "Kontaktirajte Nas",
        step1Text: "Pozovite, pošaljite WhatsApp ili email s vašim detaljima",
        step2Title: "Dobijte Potvrdu",
        step2Text: "Primite trenutnu potvrdu i ponudu cijene",
        step3Title: "Uživajte u Vožnji",
        step3Text: "Naš vozač će biti tamo na vrijeme, svaki put",
        
        // About
        aboutTitle: "O Taxi Poreč",
        aboutText1: "S dugogodišnjim iskustvom u pružanju usluga lokalnom stanovništvu i turistima u Poreču, ponosni smo što pružamo pouzdane, profesionalne taxi usluge. Naši vozači poznaju Istru iznutra i izvana, govore više jezika i predani su tome da vaše putovanje bude udobno i bez stresa.",
        aboutText2: "Bilo da stižete na aerodrom, istražujete šarmantne gradove Istre ili vam treba brza vožnja kroz Poreč, tu smo da vam pomognemo 24/7. Vaše zadovoljstvo i sigurnost su naši glavni prioriteti.",
        aboutFeature1: "Licencirani i osigurani",
        aboutFeature2: "Iskusni lokalni vozači",
        aboutFeature3: "Višejezična usluga (Hrvatski, Engleski, Njemački, Talijanski)",
        aboutFeature4: "Moderna, dobro održavana vozila",
        aboutFeature5: "Konkurentne cijene",
        aboutFeature6: "Dostupno 24/7, 365 dana godišnje",
        
        // FAQ
        faqTitle: "Često Postavljana Pitanja",
        faq1Q: "Kako rezervirati taksi?",
        faq1A: "Možete nas nazvati na +385 98743679, poslati poruku na WhatsApp ili email. Brzo odgovaramo i odmah potvrđujemo vašu rezervaciju.",
        faq2Q: "Radite li 24/7?",
        faq2A: "Da, dostupni smo non-stop, svaki dan u godini, uključujući praznike.",
        ...
        faq8A: "Vožnja taksijem od Poreča do Aerodroma Pula traje oko 60 minuta. Nudimo konkurentne fiksne cijene bez skrivenih naknada za 1-8 putnika. Kontaktirajte nas za točne cijene putem telefona +385 98743679 ili WhatsAppa.",
        ...
        // Business Summary
        businessSummary1: "<strong>Taxi Poreč je 24/7 taxi i usluga transfera do aerodroma sa sjedištem u Poreču, Hrvatska.</strong> Nudimo transfere po fiksnim cijenama do Aerodroma Pula, Aerodroma Trst, Venecije, Zagreba i destinacija diljem Istre i Europe. Rezervacija je dostupna putem telefona ili WhatsAppa (+385 98743679).",
        ...
        contactPhoneNote: "Dostupno 24/7",
        contactWhatsApp: "WhatsApp",
        contactWhatsAppNote: "Brz odgovor, jednostavna rezervacija",
        contactEmail: "Email",
        contactEmailNote: "Odgovaramo u roku od 1 sata",
        contactAddress: "Adresa",
        
        // Footer
        footerTagline: "Affordable, Reliable and Safe Taxi and Transfers Service in Poreč",
        footerQuickLinks: "Brzi Linkovi",
        footerContact: "Kontakt",
        footerHours: "Radno Vrijeme",
        footerHoursText: "24/7 - Svaki Dan",
        footerAvailability: "Uvijek dostupni za vas",
        footerCopyright: "© 2024 Poreč Taxi. Sva prava pridržana."
    },
    
    en: {
        // Meta & SEO
        metaTitle: "Taxi Poreč | 24/7 Taxi Service & Airport Transfers | +385 98743679",
        metaDescription: "Professional taxi service in Poreč, Croatia. Airport transfers, 24/7 availability, experienced drivers. Book now via WhatsApp or call +385 98743679.",
        ...
        // Hero Section
        heroTitle: "Taxi Poreč - Your Reliable Transport Partner in Istria",
        heroSubtitle: "Professional taxi service available 24/7. Airport transfers, city tours, and more. Book now for fast, comfortable rides.",
        heroCallNow: "Call Now",
        heroWhatsApp: "WhatsApp",
        
        // Why Choose Us
        whyChooseTitle: "Why Choose Taxi Poreč?",
        feature1Title: "24/7 Availability",
        feature1Text: "Round-the-clock service, every day of the year. We're here when you need us.",
        feature2Title: "Professional Drivers",
        feature2Text: "Licensed, experienced drivers with excellent local knowledge and English proficiency.",
        feature3Title: "Modern Fleet",
        feature3Text: "Clean, comfortable, air-conditioned vehicles maintained to the highest standards.",
        feature4Title: "Fixed Prices",
        feature4Text: "Transparent pricing with no hidden fees. Know your cost before you ride.",
        
        // Services
        servicesTitle: "Our Services",
        service1Title: "Airport Transfers",
        service1Desc: "Reliable transfers between Pula Airport and Poreč. Flight monitoring, meet & greet service, and comfortable rides.",
        service1Item1: "Pula Airport → Poreč: ~60 min",
        service1Item2: "Trieste Airport → Poreč: ~90 min",
        service1Item3: "Zagreb Airport → Poreč: ~3 hours",
        
        service2Title: "City Transfers",
        service2Desc: "Local transportation within Poreč and surrounding areas. Quick, efficient service for all your daily needs.",
        service2Item1: "Poreč, Tar-Vabriga, Vrsar",
        service2Item2: "Funtana, Novigrad",
        service2Item3: "Quick response",
        
        service3Title: "Istria Tours",
        service3Desc: "Discover Istria's beauty with our guided tours. Visit Rovinj, Motovun, Grožnjan, and other stunning destinations.",
        service3Item1: "Rovinj, Motovun, Pula Arena",
        service3Item2: "Brijuni Islands",
        service3Item3: "Custom tours",
        
        service4Title: "Long-Distance Transfers",
        service4Desc: "Comfortable long-distance rides to Zagreb, Ljubljana, Trieste, Venice, and other major cities.",
        service4Item1: "Zagreb, Ljubljana, Trieste",
        service4Item2: "Venice, Split",
        service4Item3: "Comfortable ride",
        
        // How to Book
        howToBookTitle: "Easy Booking in 3 Steps",
        step1Title: "Contact Us",
        step1Text: "Call, WhatsApp, or email with your details",
        step2Title: "Get Confirmation",
        step2Text: "Receive instant confirmation and price quote",
        step3Title: "Enjoy Your Ride",
        step3Text: "Our driver will be there on time, every time",
        
        // About
        aboutTitle: "About Taxi Poreč",
        aboutText1: "With years of experience serving locals and tourists in Poreč, we pride ourselves on providing reliable, professional taxi services. Our drivers know Istria inside and out, speak multiple languages, and are committed to making your journey comfortable and stress-free.",
        aboutText2: "Whether you're arriving at the airport, exploring Istria's charming towns, or need a quick ride across Poreč, we're here to help 24/7. Your satisfaction and safety are our top priorities.",
        aboutFeature1: "Licensed and insured",
        aboutFeature2: "Experienced local drivers",
        aboutFeature3: "Multilingual service (Croatian, English, German, Italian)",
        aboutFeature4: "Modern, well-maintained vehicles",
        aboutFeature5: "Competitive pricing",
        aboutFeature6: "Available 24/7, 365 days a year",
        
        // FAQ
        faqTitle: "Frequently Asked Questions",
        faq1Q: "How do I book a taxi?",
        faq1A: "You can call us at +385 98743679, message us on WhatsApp, or send an email. We respond quickly and confirm your booking immediately.",
        faq2Q: "Do you operate 24/7?",
        faq2A: "Yes, we're available around the clock, every day of the year, including holidays.",
        ...
        faq8A: "The taxi from Poreč to Pula Airport journey takes about 60 minutes. We offer competitive fixed prices with no hidden fees for 1-8 passengers. Contact us for exact pricing via phone +385 98743679 or WhatsApp.",
        ...
        // Business Summary
        businessSummary1: "<strong>Taxi Poreč is a 24/7 taxi and airport transfer service based in Poreč, Croatia.</strong> We provide fixed-price transfers to Pula Airport, Trieste Airport, Venice, Zagreb, and destinations across Istria and Europe. Booking is available via phone or WhatsApp (+385 98743679).",
        ...
        contactPhone: "Phone",
        contactPhoneNote: "Available 24/7",
        contactWhatsApp: "WhatsApp",
        contactWhatsAppNote: "Quick response, easy booking",
        contactEmail: "Email",
        contactEmailNote: "We respond within 1 hour",
        ...
        footerHours: "Hours",
        footerHoursText: "24/7 - Every Day",
        footerAvailability: "Always available for you",
        footerCopyright: "© 2024 Poreč Taxi. All rights reserved."
    },
    
    it: {
        // Meta & SEO
        metaTitle: "Taxi Poreč | Servizio Taxi 24/7 & Transfer Aeroportuali | +385 98743679",
        metaDescription: "Servizio taxi professionale a Parenzo, Croazia. Transfer aeroportuali, disponibilità 24/7, autisti esperti. Prenota ora via WhatsApp o chiama +385 98743679.",
        ...
        // Hero Section
        heroTitle: "Taxi Poreč - Il Vostro Partner Affidabile per i Trasporti in Istria",
        heroSubtitle: "Servizio taxi professionale disponibile 24/7. Transfer aeroportuali, tour della città e altro. Prenota ora per corse veloci e confortevoli.",
        heroCallNow: "Chiama Ora",
        heroWhatsApp: "WhatsApp",
        
        // Why Choose Us
        whyChooseTitle: "Perché Scegliere Taxi Poreč?",
        feature1Title: "Disponibilità 24/7",
        feature1Text: "Servizio continuo, tutti i giorni dell'anno. Siamo qui quando hai bisogno di noi.",
        feature2Title: "Autisti Professionali",
        feature2Text: "Autisti autorizzati ed esperti con eccellente conoscenza locale e padronanza dell'inglese.",
        feature3Title: "Flotta Moderna",
        feature3Text: "Veicoli puliti, confortevoli e climatizzati, mantenuti secondo i più alti standard.",
        feature4Title: "Prezzi Fissi",
        feature4Text: "Prezzi trasparenti senza costi nascosti. Conosci il costo prima della corsa.",
        
        // Services
        servicesTitle: "I Nostri Servizi",
        service1Title: "Transfer Aeroportuali",
        service1Desc: "Transfer affidabili tra l'aeroporto di Pola e Parenzo. Monitoraggio voli, servizio meet & greet e corse confortevoli.",
        service1Item1: "Aeroporto Pola → Parenzo: ~60 min",
        service1Item2: "Aeroporto Trieste → Parenzo: ~90 min",
        service1Item3: "Aeroporto Zagabria → Parenzo: ~3 ore",
        
        service2Title: "Transfer Urbani",
        service2Desc: "Trasporto locale a Parenzo e nelle aree circostanti. Servizio rapido ed efficiente per tutte le vostre esigenze quotidiane.",
        service2Item1: "Parenzo, Tar-Vabriga, Orsera",
        service2Item2: "Fontane, Cittanova",
        service2Item3: "Risposta rapida",
        
        service3Title: "Tour dell'Istria",
        service3Desc: "Scopri la bellezza dell'Istria con i nostri tour guidati. Visita Rovigno, Montona, Grisignana e altre destinazioni meravigliose.",
        service3Item1: "Rovigno, Montona, Arena di Pola",
        service3Item2: "Isole Brioni",
        service3Item3: "Tour personalizzati",
        
        service4Title: "Transfer a Lunga Distanza",
        service4Desc: "Corse confortevoli a lunga distanza per Zagabria, Lubiana, Trieste, Venezia e altre città principali.",
        service4Item1: "Zagabria, Lubiana, Trieste",
        service4Item2: "Venezia, Spalato",
        service4Item3: "Viaggio confortevole",
        
        // How to Book
        howToBookTitle: "Prenotazione Facile in 3 Passi",
        step1Title: "Contattaci",
        step1Text: "Chiama, invia un WhatsApp o un'email con i tuoi dettagli",
        step2Title: "Ricevi Conferma",
        step2Text: "Ricevi conferma immediata e preventivo",
        step3Title: "Goditi la Corsa",
        step3Text: "Il nostro autista sarà lì puntuale, ogni volta",
        
        // About
        aboutTitle: "Chi Siamo - Taxi Poreč",
        aboutText1: "Con anni di esperienza al servizio di residenti e turisti a Parenzo, siamo orgogliosi di fornire servizi taxi affidabili e professionali. I nostri autisti conoscono l'Istria a fondo, parlano più lingue e si impegnano a rendere il vostro viaggio confortevole e senza stress.",
        aboutText2: "Che stiate arrivando all'aeroporto, esplorando le affascinanti città dell'Istria o abbiate bisogno di una corsa veloce attraverso Parenzo, siamo qui per aiutarvi 24/7. La vostra soddisfazione e sicurezza sono le nostre priorità principali.",
        aboutFeature1: "Autorizzati e assicurati",
        aboutFeature2: "Autisti locali esperti",
        aboutFeature3: "Servizio multilingue (Croato, Inglese, Tedesco, Italiano)",
        aboutFeature4: "Veicoli moderni e ben mantenuti",
        aboutFeature5: "Prezzi competitivi",
        aboutFeature6: "Disponibili 24/7, 365 giorni all'anno",
        
        // FAQ
        faqTitle: "Domande Frequenti",
        faq1Q: "Come prenoto un taxi?",
        faq1A: "Puoi chiamarci al +385 98743679, inviarci un messaggio su WhatsApp o un'email. Rispondiamo rapidamente e confermiamo la tua prenotazione immediatamente.",
        faq2Q: "Operate 24/7?",
        faq2A: "Sì, siamo disponibili 24 ore su 24, tutti i giorni dell'anno, festivi inclusi.",
        ...
        faq8A: "Il viaggio in taxi da Parenzo all'Aeroporto di Pola dura circa 60 minuti. Offriamo prezzi fissi competitivi senza costi nascosti per 1-8 passeggeri. Contattateci per i prezzi esatti tramite telefono +385 98743679 o WhatsApp.",
        ...
        contactPhoneNote: "Disponibile 24/7",
        contactWhatsApp: "WhatsApp",
        contactWhatsAppNote: "Risposta rapida, prenotazione facile",
        contactEmail: "Email",
        contactEmailNote: "Rispondiamo entro 1 ora",
        contactAddress: "Indirizzo",
        
        // Footer
        footerTagline: "Servizio Taxi e Transfer Economico, Affidabile e Sicuro a Parenzo",
        footerQuickLinks: "Link Rapidi",
        footerContact: "Contatti",
        footerHours: "Orari",
        footerHoursText: "24/7 - Ogni Giorno",
        footerAvailability: "Sempre disponibili per voi",
        footerCopyright: "© 2024 Poreč Taxi. Tutti i diritti riservati."
    }
};
